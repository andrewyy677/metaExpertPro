...
for my $dir (@dir) {
	...
	while (<TMP>) {
		...
		open (IN, "<$file") or die $!;
		open (BREP, ">$workdir/05.eggnog.run/02.matrix/$dir/biorep/$project\_diann1.8_$database\_$type\_$taxon\_biorep.txt") or die $!;
		open (TREP, ">$workdir/05.eggnog.run/02.matrix/$dir/techrep/$project\_diann1.8_$database\_$type\_$taxon\_techrep.txt") or die $!;
		open (POOL, ">$workdir/05.eggnog.run/02.matrix/$dir/pool/$project\_diann1.8_$database\_$type\_$taxon\_pool.txt") or die $!;
		open (QC, ">$workdir/05.eggnog.run/02.matrix/$dir/qc/$project\_diann1.8_$database\_$type\_$taxon\_qc.txt") or die $!;
		open (OUT, ">$workdir/05.eggnog.run/02.matrix/$dir/sample/$project\_diann1.8_$database\_$type\_$taxon\_sample.txt") or die $!;
		open (ALL, ">$workdir/05.eggnog.run/02.matrix/$dir/all/$project\_diann1.8_$database\_$type\_$taxon\_all.txt") or die $!;
		my $line = 0; my @head;
