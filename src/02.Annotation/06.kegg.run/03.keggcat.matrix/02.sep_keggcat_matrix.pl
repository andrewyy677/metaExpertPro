...
for my $dir (@dir) {
	...
	while (<TMP>) {
		...
		open (IN, "<$file") or die $!;
		open (BREP, ">$workdir/06.kegg.run/03.keggcat.matrix/$dir/biorep/$project\_diann_$database\_$type\_$taxon\_biorep.txt") or die $!;
		open (TREP, ">$workdir/06.kegg.run/03.keggcat.matrix/$dir/techrep/$project\_diann_$database\_$type\_$taxon\_techrep.txt") or die $!;
		open (POOL, ">$workdir/06.kegg.run/03.keggcat.matrix/$dir/pool/$project\_diann_$database\_$type\_$taxon\_pool.txt") or die $!;
		open (QC, ">$workdir/06.kegg.run/03.keggcat.matrix/$dir/qc/$project\_diann_$database\_$type\_$taxon\_qc.txt") or die $!;
		open (OUT, ">$workdir/06.kegg.run/03.keggcat.matrix/$dir/sample/$project\_diann_$database\_$type\_$taxon\_sample.txt") or die $!;
		open (ALL, ">$workdir/06.kegg.run/03.keggcat.matrix/$dir/all/$project\_diann_$database\_$type\_$taxon\_all.txt") or die $!;
		my $line = 0; my @head;
