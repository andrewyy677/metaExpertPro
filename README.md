...
```
$ docker pull guomics2017/metaexpertpro:v2.1
```
...
```
docker run -it --rm -u $(id -u):$(id -g) guomics2017/metaexpertpro:v2.1 sh /metaEx/src/00.DDAspectrallib/00.DDA.DIA.sh --help
```
...
guomics2017/metaexpertpro:v2.1 sh /metaEx/src/00.DDAspectrallib/00.DDA.DIA.sh \
...
```
docker run -it --rm -u $(id -u):$(id -g) guomics2017/metaexpertpro:v2.1 sh /metaEx/src/02.Annotation/01.annotation.sh --help
```
...
guomics2017/metaexpertpro:v2.1 sh /metaEx/src/02.Annotation/01.annotation.sh --total_dir /metaEx --project_name xxx --sample_label /metaEx/sampleLabel/xxx \
