...
database.db-path=/metaEx/Results/00.DDAspectrallib/2024-03-23-decoys-IGC_unique.catalogue_modify_shuffle_humanswiss_contam_irt.fasta.fas
...
fragpipe-config.bin-ionquant=/metaEx/software/fragpipe20.0/software/IonQuant-1.9.8/IonQuant-1.9.8.jar
fragpipe-config.bin-msfragger=/metaEx/software/fragpipe20.0/software/MSFragger-3.8/MSFragger-3.8.jar
fragpipe-config.bin-philosopher=/metaEx/software/fragpipe20.0/software/philosopher-5.0.0/philosopher
fragpipe-config.bin-python=/opt/conda/bin/python
freequant.mz-tol=10
...
workdir=/metaEx/Results/00.DDAspectrallib
